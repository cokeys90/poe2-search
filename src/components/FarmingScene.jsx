...
/* 구르기: 펄쩍 도약(translateY 아치)하며 앞으로 한 바퀴 플립 */
@keyframes fh-roll {
  0%, 30% { transform: translateY(0) rotate(0deg); }
  33% { transform: translateY(-7px) rotate(130deg); }
  35% { transform: translateY(-11px) rotate(230deg); }
  38% { transform: translateY(0) rotate(360deg); }
  51% { transform: translateY(0) rotate(360deg); }
  54% { transform: translateY(-7px) rotate(490deg); }
  56% { transform: translateY(-11px) rotate(590deg); }
  59% { transform: translateY(0) rotate(720deg); }
  73% { transform: translateY(0) rotate(720deg); }
  76% { transform: translateY(-7px) rotate(850deg); }
  78% { transform: translateY(-11px) rotate(950deg); }
